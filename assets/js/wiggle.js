...
! function (n, e) {
    ...
    function j(n) {
        if (!C)
            if (r = g(), y = r && r.parseEase("_CE")) {
                for (var e in M) M[e] = y("", M[e]);
                C = 1, t("wiggle").config = function (n) {
    ...
    function k(e, n) {
        return "function" != typeof e && (e = r.parseEase(e) || y("", e)), e.custom || !n ? e : function (n) {
            return 1 - e(n)
        }
    }
    ...
    var r, C, y, M = {
        ...
        W = function (e) {
            var t = 0 === (window ? window.location.href : "").indexOf(n(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(n(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== e.indexOf(n(49, 50, 55, 46, 48, 32, 48, 46, 49)),
        ...
        t = function _create(n, e) {
            ...
            var t, o, r, u, s, a, f, g, l, c = 0 | ((e = e || {}).wiggles || 10),
                ...
                p = d / 2,
                w = "anticipate" === e.type,
                m = M[e.type] || M.easeOut,
                h = i;
            if (W) {
                if (w && (h = m, m = M.easeOut), e.timingEase && (h = k(e.timingEase)), e.amplitudeEase && (m = k(e.amplitudeEase, !0)), g = [0, 0, (a = h(p)) / 4, 0, a / 2, f = w ? -m(p) : m(p), a, f], "random" === e.type) {
                    for (g.length = 4, t = h(d), o = 2 * Math.random() - 1, l = 2; l < c; l++) p = t, f = o, t = h(d * l), o = 2 * Math.random() - 1, r = Math.atan2(o - g[g.length - 3], t - g[g.length - 4]), u = Math.cos(r) * d, s = Math.sin(r) * d, g.push(p - u, f - s, p, f, p + u, f + s);
                    g.push(t, 0, 1, 0)
                } else {
                    for (l = 1; l < c; l++) g.push(h(p + d / 2), f), p += d, f = (0 < f ? -1 : 1) * m(l * d), a = h(p), g.push(h(p - d / 2), f, a, f);
                    g.push(h(p + d / 4), f, h(p + d / 4), 0, 1, 0)
                }
    ...
    g() && r.registerPlugin(o), o.version = "3.8.0", e.CustomWiggle = o, e.default = o;
